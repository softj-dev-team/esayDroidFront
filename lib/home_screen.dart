...
import 'best_flutter_ui_templates/model/homelist.dart';
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  appBar(),
                  SizedBox(height: 100),
                  Image.asset('assets/images/logo.png', width: 320.0, height: 320.0), // 이미지 추가
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      // SizedBox(width: 200), // 텍스트와 아이콘 사이의 간격
                      IconButton(
